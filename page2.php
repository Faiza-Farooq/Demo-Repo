...
<option value="Zimbabwe">Zimbabwe</option>
    ...
    <tr>
      ...
      <td><label for="Ad1"></label>
      <input type="text" name="Ad1" id="Ad1" /></td>
    </tr>
    <tr>
      <th scope="row">Street Address 2</th>
      <td><label for="Ad2"></label>
      <input type="text" name="Ad2" id="Ad2" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <input name="pnumber" type="text" id="pnumber" value="" size="15" /></td>
    </tr>
  </table>
</form>
<p>&nbsp;</p>
